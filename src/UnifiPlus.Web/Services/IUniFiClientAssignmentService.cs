...
public interface IUniFiClientAssignmentService
{
    ...
    Task<DashboardViewModel> BuildDashboardAsync(string userId, bool isAdmin, CancellationToken cancellationToken);
    ...
    Task AssignClientAsync(string userId, string clientId, CancellationToken cancellationToken);
    ...
    Task UpdateWanAsync(string userId, string clientId, string wanId, CancellationToken cancellationToken);
    ...
    Task UpdateBandwidthAsync(string userId, string clientId, int? downloadLimitMbps, int? uploadLimitMbps, CancellationToken cancellationToken);
}
